...
public class ProvisionLanding extends AppCompatActivity {
    ...
    private TextView textWiFiInstruction, textNoInternet;
                ...
                transport.sendConfigData(AppConstants.HANDLER_PROTO_VER, tempData.getBytes(), new ResponseListener() {
                    ...
                    public void onSuccess(byte[] returnData) {
                        ...
                        try {
                            ...
                            // If received data is "V0.1" then consider that WiFi auth mode will be available in WiFi Scan list.
                            if (!TextUtils.isEmpty(data) && data.equalsIgnoreCase("V0.1")) {
